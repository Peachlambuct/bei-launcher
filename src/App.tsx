        ...
        {view === "launcher" && (
          <Command loop className="flex flex-col w-full h-full">
            ...
            <div className="flex items-center gap-3 px-4 py-4 border-b border-white/10">
              ...
              />
              <div className="text-xs text-gray-600 font-mono border border-gray-700 rounded px-1.5 py-0.5">
                ESC
              </div>
            </div>
            ...
            <Command.List className="flex-1 overflow-y-auto p-2 scrollbar-hide">
              ...
              <Command.Group
                heading="Tools"
                className="text-xs font-medium text-gray-500 px-2 py-1.5 mb-1 uppercase tracking-wider"
              >
                {plugins.map((plugin) => (
                  <Command.Item
                    key={plugin.id}
              ...
              {apps.length > 0 && (
                <Command.Group
                  ...
                  className="text-[10px] font-bold text-gray-500 px-2 py-2 uppercase tracking-widest border-t border-white/5 mt-2 pt-2"
                >
                  {apps.map((app) => (
                    <Command.Item
                      key={app.path}
